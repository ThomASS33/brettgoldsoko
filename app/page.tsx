      ...
      <div className="mb-32 grid gap-4 justify-center text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <img
            ...
            alt="Linktree Logo"
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 opacity-100 transition-opacity duration-300 group-hover:opacity-100"
            style={{ mixBlendMode: 'multiply' }}
          />
        </a>
        ...
        >
          ...
          <img
            ...
            alt="Twitter Logo"
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-7/11 opacity-100 transition-opacity duration-300 group-hover:opacity-100"
            style={{ mixBlendMode: 'multiply' }}
          />
        </a>
        ...
        <Link href="/sokoban-gold" passHref>
          <div className="group relative z-10 rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-green-500 hover:bg-yellow-400 hover:dark:border-yellow-400 hover:dark:bg-green-500 flex items-start justify-center w-32 h-32">
            ...
            <img
              src="/pow-logo.svg"
              alt="PoW Logo"
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4/5 opacity-100 transition-opacity duration-300 group-hover:opacity-100"
              style={{ mixBlendMode: 'multiply' }}
            />
          </div>
        </Link>
